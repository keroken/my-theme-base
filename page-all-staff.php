        ...
        ?>
          ...
          <div class="staff-item">
            ...
            <div class="staff-details">
              ...
              <span class="staff-title"><?php echo esc_html($staff_title); ?></span>
              <span class="staff-location"><?php echo esc_html($staff_location); ?></span>
            </div>
          </div>

        <?php endwhile; //------------repeat end---------- 
        ?>
